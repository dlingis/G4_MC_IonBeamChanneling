...
/*
    inline void SetEdep(G4double z) { fEdepstep = z;}
    inline G4double GetEdep() const { return fEdepstep;}
    inline void SetNiel(G4double z) { fNielstep = z;}
    inline G4double GetNiel() const { return fNielstep;}*/
};
